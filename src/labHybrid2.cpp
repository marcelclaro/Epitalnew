...
int main(){
	...
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InAlAs>(77,0.52),15.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InGaAs>(77,0.53),32.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InAlAs>(77,0.52),30.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InGaAs>(77,0.53),32.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InAlAs>(77,0.52),30.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InGaAs>(77,0.53),32.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InAlAs>(77,0.52),40.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InGaAs>(77,0.53),97.0_Angs, 0.5e+18_under_cubic_cm));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InAlAs>(77,0.52),40.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InGaAs>(77,0.53),32.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InAlAs>(77,0.52),30.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InGaAs>(77,0.53),32.0_Angs));
	...
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<InAlAs>(77,0.52),15.0_Angs));
/*
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<MgZnCdSe>(77,0.29,0.45),thicknesserror*100.0_Angs));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<ZnCdSe>(77,0.48),thicknesserror*23.0_Angs,2.0e+18_under_cubic_cm));
	layers.push_back(Heterostructure<double>::Epilayer(make_shared<MgZnCdSe>(77,0.29,0.45),thicknesserror*100.0_Angs));
*/
...
*/
    ...
    SolutionPW<double,double> solution = SolverTM<double,double>::SolvePeriodic(sample,Band::Conduction, 9, 0.001_eV,1.021_eV,1.84_eV);
...
*/
	...
	cout << "Wavelegth:" << endl;
	cout << 1240/energy_to_eV(solution.getEnergy(3).real()-solution.getEnergy(0).real()) << "\n";
...
*/
	vector<double> widths = SolverTM<double,double>::getminibandwidth(sample,Band::Conduction,solution,6);

	cout << "Widths:" << endl;
	cout << energy_to_eV(widths[0]) << "\n";
	cout << energy_to_eV(widths[1]) << "\n";
	cout << energy_to_eV(widths[2]) << "\n";
	cout << energy_to_eV(widths[3]) << "\n";
	cout << energy_to_eV(widths[4]) << "\n";
	cout << energy_to_eV(widths[5]) << "\n";
/*
