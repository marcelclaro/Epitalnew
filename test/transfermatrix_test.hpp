...
double test_transfermatrix(double wellwidth_angs){
    ...
    SolutionPW<double,double> solution = SolverTM<double,double>::SolvePeriodic(sample,Band::Conduction, 1, 0.001_eV,1.42_eV,1.9_eV);
